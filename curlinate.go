...
var args struct {
	URL        string   `arg:"" help:"Fully qualified URL to contact" required:""`
	...
	JA3        string   `name:"ja3" help:"Raw JA3 fingerprint to forge, or name of existing preset" env:"JA3" required:""`
}
